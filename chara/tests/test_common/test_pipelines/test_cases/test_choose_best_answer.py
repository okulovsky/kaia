...
from chara.common.pipelines.cases import IVotingCase, CaseCache, ChooseBestAnswerPipeline, ICasePipeline
...
class Pipeline:
    ...
    def __call__(self, cache: CaseCache[VotingCase], cases: list[VotingCase]):
        i = self.call_count
        self.call_count += 1
        for case in cases:
