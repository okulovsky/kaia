...
class LanguageSettings:
    ...
    upsampling_prefix: str
    upsampling_suffix: str
    ...
    def from_language(language: Language) -> 'LanguageSettings':
        if language.code == 'en':
            return LanguageSettings(
                ...
                upsampling_prefix="The beginning. ",
                upsampling_suffix=" The end.",
        ...
        if language.code == 'ru':
            return LanguageSettings(
                ...
                upsampling_prefix="Я начинаю. ",
                upsampling_suffix=" Я закончил.",
        ...
        if language.code == 'de':
            return LanguageSettings(
                ...
                upsampling_prefix="Der Beginn. ",
                upsampling_suffix=" Das Ende.",
...
class DistillationSettings:
    ...
    required_samples_duration_in_seconds: float = 60*60
    upsampling_batch_size: int = 100
    max_upsampling_iterations: int = 20
    max_upsampling_attempts: int = 3
