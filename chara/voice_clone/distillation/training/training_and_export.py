from chara import Chara, brainbox_training_pipeline, ICase, BrainBoxCasePipeline, CaseCollection
...
def _case_to_export(case: CheckpointCase):
    return PiperTraining.new_task().export(case.checkpoint.filename)
