...
class ComfyUI(IApiDecider):
    def __init__(self,
                 ...
                 input_folder: Path,
                 output_folder: Path,
                 decider_parameters: str|None = None
                 ):
    ...
    def run_workflow(self, workflow: IWorkflow):
        input_files = []
        ...
        json = workflow.create_workflow_json(self.current_job_id, self.decider_parameters)
