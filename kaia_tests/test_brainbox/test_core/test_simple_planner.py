...
from kaia.brainbox.core import BrainBoxJob, DeciderState
from kaia.brainbox.core.simple_planner import SimplePlanner
...
class SimplePlannerTestCase(TestCase):
    ...
    def test_cooldown(self):
        ...
        self.assertIsNone(plan.assign_tasks)
        self.assertIsNone(plan.warm_up)
        self.assertEqual(('b',), plan.cool_down)
