...
from kaia_tests.test_kaia.test_audio_control.kaia_test_app import KaiaTestService, KaiaCoreAudioControlServiceSettings
...
class KaiaIntegrationTestCase(TestCase):
    ...
    def test_kaia_integration(self):
            ...
            with create_brainbox_test_api(folder) as bb_api:
                ...
                with WavStreamingTestApi(WavApiSettings(), WavServerSettings(folder)) as wav_api:
                    with AvatarApi.Test(AvatarSettings(brain_box_api=bb_api)) as avatar_api:
                        ...
                        kaia = KaiaTestService(KaiaCoreAudioControlServiceSettings(
                            avatar_api,
                            kaia_gui_api,
                            audio_api,
                            bb_api
