...
def wait_for_chat(api, messages_count, max_waiting_time):
...
class DemoTestCase(TestCase):
    def test_demo(self):
        ...
        with app.app.test_runner():
            wait_for_chat(app.gui_api, 3, 60)
            ...
            wait_for_chat(app.gui_api, 5, 10)
            ...
            wait_for_chat(app.gui_api, 7, 10)

            app.audio_api.next_mic_sample()
            app.audio_api.wait_for_mic_sample_to_finish()

            wait_for_chat(app.gui_api, 9, 10)
