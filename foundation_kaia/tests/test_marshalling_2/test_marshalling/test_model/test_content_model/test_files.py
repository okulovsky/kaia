...
from foundation_kaia.marshalling_2.marshalling.model import CallModel, endpoint, FileLike
...
class TestFiles(unittest.TestCase):
    ...
    def test_all_together(self):
        ...
        self.assertEqual({'f': b'data'}, c.files)
        self.assertEqual({'meta': {'name':'test'}}, c.json)
