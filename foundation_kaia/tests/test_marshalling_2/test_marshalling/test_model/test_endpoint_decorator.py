import unittest
from foundation_kaia.marshalling_2.marshalling.model.endpoint_decorator import (
    endpoint, HttpMethod, EndpointAttributes, _ENDPOINT_ATTR,
)
...
class TestVerifyAbstract(unittest.TestCase):
    ...
    def test_stub_body_ellipsis_accepted(self):
        ...
        self.assertTrue(hasattr(my_ep, _ENDPOINT_ATTR))
...
class TestDecoratorAttributes(unittest.TestCase):
    ...
    def test_defaults(self):
        @endpoint
        def my_ep(self) -> None: ...
        attrs: EndpointAttributes = getattr(my_ep, _ENDPOINT_ATTR)
